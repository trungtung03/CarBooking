...
import com.example.carbooking.adapter.PlaceAdapter;
import com.example.carbooking.network.MeasureDistanceOnMap;
...
public class DestinationActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startLocation = findViewById(R.id.starting_location);
        ...
        distanceTravel = findViewById(R.id.distance_travel);

        ImageView deleteDestinationAddress = findViewById(R.id.delete_destination);
        deleteDestinationAddress.setOnClickListener(view -> destinationLocation.setText(""));

        Button getCostButton = findViewById(R.id.get_cost);
        getCostButton.setOnClickListener(view -> {
